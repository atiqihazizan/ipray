...
class ApiServerService {
  ...
  setupRoutes() {
    ...
    this.app.get('/api/data/app', async (req, res) => {
      try {
        const [takwimContent, announcementsContent, kuliahContent, kuliahOverrideContent, imagesContent, slidesContent, configContent, slideshowContent] = await Promise.all([
