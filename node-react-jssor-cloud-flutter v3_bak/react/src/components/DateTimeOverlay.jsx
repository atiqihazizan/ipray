        ...
        <div className='relative flex flex-col'>
          ...
          <div className="flex justify-between items-end w-full">
            ...
            <div className='flex flex-col justify-end w-full'>
              <Marquee text={hebahanText} duration={MARQUEE_CONFIG.DURATION} className="w-full" enabled={marqueeEnabled && showMarqueeOverride} style={{ ...STANDARD_DARK_BACKGROUND_STYLE }} />
            </div>
