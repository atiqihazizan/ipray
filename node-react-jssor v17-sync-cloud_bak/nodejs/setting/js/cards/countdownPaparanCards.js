/**
 * Komponen kad untuk Countdown → Setting Paparan.
 * Struktur dan inline editor meniru Pengumuman/Slideshow → Setting Paparan.
 * Fail ini hanya bina DOM & inline editor; fetch data & state kekal di table.js.
 */

/**
 * Render kad Countdown Paparan dengan editor inline.
 * @param {Object} opts
 * @param {HTMLElement} opts.gridEl
 * @param {Array<object>} opts.data - Row slides (type=countdown; duration dalam saat)
 ...
 */
export function renderCountdownPaparanCards({
  gridEl,
  data,
  imagesList,
  BASE_URL,
  ...
  data.forEach((row) => {
    ...
    hideSpan.textContent = "Countdown";
