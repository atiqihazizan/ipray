...
export function initSocket() {
  ...
  // Hebahan: backend emit hebahan:updated (bukan data:updated), jadi reload table hebahan bila event diterima
  socket.on("hebahan:updated", () => {
    if (document.getElementById("hebahan-thead") && document.getElementById("hebahan-tbody")) {
      loadTable("hebahan");
    }
  });
