          ...
          child: Column(
            ...
            children: [
              Row(
                children: [
                  const Expanded(
                    child: Text('Pilih pemisah mesej', style: TextStyle(fontSize: 16, fontWeight: FontWeight.w600)),
                  ),
                ...
                children: [
                  for (final it in items)
                    InkWell(
                      onTap: () {
                        setState(() {
                          _marqueeSeparator = it;
                          _configData['MARQUEE_SEPARATOR'] = it;
                        });
                        _socketService?.saveConfigItem('MARQUEE_SEPARATOR', it);
                        Navigator.pop(ctx);
                      },
                      ...
                      child: Container(
                        ...
                        child: Text(it, style: const TextStyle(fontSize: 18, fontWeight: FontWeight.w600)),
                      ),
                    ),
                ],
              ),
              ...
              TextField(
                ...
                decoration: const InputDecoration(
                  labelText: 'Atau masukkan emoji sendiri',
                ...
                onSubmitted: (v) {
                  ...
                  setState(() {
                    _marqueeSeparator = val;
                    _configData['MARQUEE_SEPARATOR'] = val;
                  });
                  _socketService?.saveConfigItem('MARQUEE_SEPARATOR', val);
                  Navigator.pop(ctx);
                },
              ),
            ],
