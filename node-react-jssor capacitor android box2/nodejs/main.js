...
// Global constants
const PUBLIC_PORT = 4100;
const SETTING_PORT = 4101; // API Server dan Socket.IO share port ini
...
async function startServers() {
  try {
    ...
    // API + Socket.IO + panel Setting (statik dari settingPath) pada port SETTING_PORT.
    // Deploy nginx: /setting/ → proxy ke port ini (fail HTML/JS panel).
