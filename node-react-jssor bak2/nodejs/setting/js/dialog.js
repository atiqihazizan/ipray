...
export function openAddDialog() {
    ...
    // Allow add untuk announcements, images, slideshow, dan kuliah-override
    if (currentFileName !== 'announcements' && currentFileName !== 'images' && currentFileName !== 'slideshow' && currentFileName !== 'kuliah-override') {
        showNotification('✗ Fungsi tambah hanya untuk Pengumuman, Images, Slideshow, dan Override Kuliah', 'error');
        return;
    }
