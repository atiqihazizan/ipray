...
async function startServers() {
  try {
    ...
    // RTSP→HLS untuk CCTV. Electron: guna config.FFMPEG_PATH jika ffmpeg tiada dalam PATH; log ke fail
    const ffmpegPath = (config.FFMPEG_PATH && String(config.FFMPEG_PATH).trim()) || null;
