...
export const useSlides = () => {
  ...
  const stableSlideData = useMemo(() => {
    ...
    return slides;
  }, [announcementsData, kuliahHariProcessed, kuliahMingguProcessed, kuliahBulananProcessed, imagesData, slidesConfigData, slideshowData, dataLoading, isReloading, reloadCounter]);
