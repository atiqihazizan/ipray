/**
 * Komponen kad untuk Pengumuman → Setting Paparan.
 * Struktur dan inline editor meniru Slideshow → Setting Paparan.
 * Fail ini hanya bina DOM & inline editor; fetch data & state kekal di table.js.
 */

/**
 * Render kad Pengumuman Paparan dengan editor inline.
 * @param {Object} opts
 * @param {HTMLElement} opts.gridEl
 * @param {Array<object>} opts.data - Row slides (type=announce; duration dalam saat)
 ...
 */
export function renderAnnouncementPaparanCards({
  gridEl,
  data,
  imagesList,
  BASE_URL,
  ...
  data.forEach((row) => {
    ...
    hideSpan.textContent = "Pengumuman";
