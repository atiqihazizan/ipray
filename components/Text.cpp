...
Text Text::customText(const sf::Vector2f &position, unsigned int characterSize,
...
Text Text::yearMonth(const std::string &str) {
  Text temp = temp.customText(sf::Vector2f(0, 0), 70, sf::Color::Cyan,
                              sf::Text::Bold, "bebas");
  temp.setString(str);
  return temp;
}
...
Text Text::dayNumber(const std::string &str) {
  Text temp = temp.customText(sf::Vector2f(0, 0), 160, sf::Color(255, 0, 255),
                              sf::Text::Bold, "bebas");
  temp.setString(str);
  return temp;
}
...
Text Text::dayName(const std::string &str) {
  Text temp = temp.customText(sf::Vector2f(0, 0), 70, sf::Color::White,
                              sf::Text::Bold, "bebas");
  temp.setString(str);
  return temp;
}
...
Text Text::prayerName(const std::string &str) {
  Text temp = temp.customText(sf::Vector2f(0, 0), 40, sf::Color::White,
                              sf::Text::Bold, "bebas");
  temp.setString(str);
  return temp;
}
...
Text Text::prayerTime(const std::string &str) {
  Text temp = temp.customText(sf::Vector2f(0, 0), 80, sf::Color::Red,
                              sf::Text::Bold, "bebas");
  temp.setString(str);
  return temp;
}
...
Text Text::currentTime(const std::string &str) {
  Text temp = temp.customText(sf::Vector2f(0, 0), 150, sf::Color::Yellow,
                              sf::Text::Bold, "bebas");
  temp.setString(str);
  return temp;
}
...
Text Text::loading(float windowWidth, float windowHeight) {
  ...
  text.text.setString("Loading Data...");
...
float Text::getWidth() const { return text.getGlobalBounds().width; }

float Text::getHeight() const { return text.getGlobalBounds().height; }
