...
TimeSolat::TimeSolat(Text& currentHour, Text& currentMinute, Text& currentColon,
    ...
    , m_currentColon(currentColon)
    , m_prayerNames(prayerNames)
    , m_prayerTimes(prayerTimes)
    , m_state(state)
    , m_dayNumber(Text::dayNumber(""))
    , m_dayName(Text::dayName(""))
    , m_monthYear(Text::yearMonth(""))
    , m_dayHNumber(Text::dayNumber(""))
    , m_dayHName(Text::dayName(""))
    , m_monthHYear(Text::yearMonth(""))
{
}
...
void TimeSolat::update() {
    ...
    setupHijriDate(m_dayHNumber, m_dayHName, m_monthHYear, hijriComponents, m_state);
    ...
    setupDate(m_dayNumber, m_dayName, m_monthYear, dateComponents, m_state);
}
